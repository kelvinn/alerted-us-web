...
if ON_DO or ON_DOCKER:
    ...
    REDIS_ENDPOINT = os.environ["REDIS_B5CEC34B_1_PORT_6379_TCP_ADDR"]
    REDIS_PORT = os.environ["REDIS_B5CEC34B_1_PORT_6379_TCP_PORT"]
    REDIS_PASSWORD = os.getenv('REDIS_B5CEC34B_1_ENV_REDIS_PASS', '')
    REDIS_URL = '%s:%s:1' % (REDIS_ENDPOINT, REDIS_PORT)
    DB_NAME = os.environ['DB_NAME']
    DB_USER = os.environ['DB_USER']
    DB_PASSWD = os.environ['DB_PASSWORD']
...
INTERNAL_IPS = ('127.0.0.1', '10.0.2.2', '10.69.18.71', '123.243.19.133')
